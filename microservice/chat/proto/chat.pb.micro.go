...
type ChatService interface {
	...
	MarkRead(ctx context.Context, in *ReadRequest, opts ...client.CallOption) (*Response, error)
}
...
func (c *chatService) MarkRead(ctx context.Context, in *ReadRequest, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "ChatService.MarkRead", in)
	out := new(Response)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
type ChatServiceHandler interface {
	...
	MarkRead(context.Context, *ReadRequest, *Response) error
}
...
func RegisterChatServiceHandler(s server.Server, hdlr ChatServiceHandler, opts ...server.HandlerOption) error {
	type chatService interface {
		...
		MarkRead(ctx context.Context, in *ReadRequest, out *Response) error
	}
	type ChatService struct {
		chatService
	}
...
func (h *chatServiceHandler) MarkRead(ctx context.Context, in *ReadRequest, out *Response) error {
	return h.ChatServiceHandler.MarkRead(ctx, in, out)
}
